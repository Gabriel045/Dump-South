    ...
    <div class="block_content">
        <div class="mb-[50px] flex flex-col items-center">
            ...
            <?php if (!empty($paragraph)) : ?>
                <p class="<?php echo ($background != "White") ? "text-text-secondary" : "text-text" ?> lg:w-[65%] text-[16px] lg:text-[18px] text-center mt-[17px]"><?php echo $paragraph ?></p>
            <?php endif ?>
        </div>
        <div class="flex flex-row flex-wrap <?php echo ($layout != "Icon") ? 'justify-start' : 'justify-center' ?>">
            <?php foreach ($cards as $key => $card) : ?>
                <div class="<?php echo ($block['className'] == 'w-50') ? 'w-50' : '' ?> flex three-col-card w-full lg:w-[33.3%] lg:px-[5px] mt-[10px]  last:mb-0 ">
                    <div class="bg-[#ffffff0f] w-full rounded-[10px] <?php echo ($background == "White") ? 'border-[1px] border-[#0000000d]' : '' ?> ">
                        ...
                        <div class="p-[20px] ">
                            <p class="<?php echo ($background != "White") ? "text-white" : "text-secondary" ?> text-[16px] lg:text-[18px] font-[700]"><?php echo $card['text'] ?></p>
