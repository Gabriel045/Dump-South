...
<section class="">
    <div class="block_content">
        <div class="flex lg:flex-nowrap flex-wrap lg:gap-[80px]">
            <div class="w-full lg:text-start text-center lg:w-1/2 relative mb-[60px] lg:mb-0">
                <div class="mb-[46px]"><?php echo $title ?></div>
                <p class="text-[18px] font-[400] text-text mt-[20px] mb-[40px]"> <?php echo $text ?></p>
                ...
                <?php foreach ($items as $key => $item) : ?>
                    <div class="item-content flex  items-start mb-[60px]">
                        ...
                        <div class="flex flex-col w-[80%]">
                            <span class="text-[18px] font-[700] text-secondary  mb-[5px]"><?php echo $item['title'] ?></span>
                            <span class="text-[18px] font-[400] text-text lg:w-[90%]"> <?php echo  $item['paragraph'] ?> </span>
                        </div>
                    </div>
                <?php endforeach ?>
