        ...
        <div class="flex lg:flex-nowrap flex-wrap lg:gap-[80px]">
            <div class="w-full lg:w-1/2 relative mb-[60px] lg:mb-0 realtive">
                <div class="lg:sticky top-[20px]">
                    <div class="<?php echo ($background != "White") ? 'text-white' : 'text-secondary' ?> text-start"><?php echo $title ?></div>
                    <p class=" <?php echo ($background != "White") ? 'text-text-secondary' : 'text-text' ?> text-[18px] font-[400] mt-[20px]  text-start "> <?php echo $text ?></p>
                    <?php echo (!empty($cta["url"])) ? '<div class="flex mt-[40px]"> <a href="' . $cta["url"] . '" class="orange_button">' . $cta['text'] . '</a> </div>' : '' ?>
                </div>
            </div>
