...
<body <?php body_class(); ?>>
  ...
  <header class="overflow-x-clip flex justify-center relative ">
    <div class="max-w-[1440px] px-[30px] lg:px-[100px] w-full items-center flex absolute z-[999] top-[20px]">
      ...
      <div class="hidden lg:flex w-[67%]  justify-center">
        <?php echo wp_nav_menu(array(
          'menu'   => 'Header menu',
        )); ?>
      </div>
      <div class="w-1/2 lg:w-[18%] flex justify-end">
        ...
        <a href="<?php esc_url(the_field('header', 'option'))  ?>" class="orange_button">GET STARTED</a>
      </div>
    </div>
